...
export interface DepositSummaryReportGetFeaturesResultType {
  type: string;
  features: DepositSummaryReportFeatureResultType[];
  totalFeature: number;
...
export interface DepositSummaryReportFeatureResultType {
  type: string;
  id: string;
  geometry: {
    type: string;
  ...
  properties: DepositSummaryReportResultType | DepositSummaryGeochemistryFeaturePropertiesType;
}
...
export interface DepositWfsResultType {
  type: string;
  features: DepositSummaryReportFeatureResultType[];
...
export interface DepositSummaryReportResultType {
  ACCURACY_M: number;
...
export interface DepositWfsResourceReservesResultType {
  type: string;
  features: DepositResourceFeatureResultType[];
  totalFeatures: number;
  numberMatched: number;
  numberReturned: number;
  timeStamp: string;
...
export interface DepositWfsResourceReservesResultType_OLD {
  type: string;
  features: DepositResourceFeatureResultType_OLD[];
  totalFeatures: number;
  numberMatched: number;
  numberReturned: number;
  timeStamp: string;
...
export interface DepositResourceFeatureResultType {
  type: string;
  id: string;
  geometry: {
    type: string;
...
export interface DepositResourceFeatureResultType_OLD {
  type: string;
  id: string;
  geometry: {
    type: string;
  ...
  geometry_name?: string;
  properties: DepositResourceReservesPropertiesType_OLD;
}
...
export interface DepositResourceReservesPropertiesType_OLD {
  '@featureType': string;
  classificationMethodUsed: string;
  classificationMethodUsed_uri: string;
  commodity: string;
  commodityClassifier_uri: string;
  commodityRank: string;
  identifier: string;
  mineName?: string;
  mine_uri?: string;
  mineralOccurrenceName: string;
  mineralOccurrence_uri: string;
  observationMethod: string;
  positionalAccuracy: string;
  resourcesCategory?: string;
  resourcesCategory_uri?: string;
  reservesCategory?: string;
  reservesCategory_uri?: string;
